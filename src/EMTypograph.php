...
use altynbek07\emtypograph\EMT_Lib;
use altynbek07\emtypograph\EMT_Tret;
use altynbek07\emtypograph\EMT_Base;

class EMTypograph extends EMT_Base
{
    public $trets = array(
        'altynbek07\emtypograph\EMT_Tret_Quote',
        'altynbek07\emtypograph\EMT_Tret_Dash',
        'altynbek07\emtypograph\EMT_Tret_Symbol',
        'altynbek07\emtypograph\EMT_Tret_Punctmark',
        'altynbek07\emtypograph\EMT_Tret_Number',
        'altynbek07\emtypograph\EMT_Tret_Space',
        'altynbek07\emtypograph\EMT_Tret_Abbr',
        'altynbek07\emtypograph\EMT_Tret_Nobr',
        'altynbek07\emtypograph\EMT_Tret_Date',
        'altynbek07\emtypograph\EMT_Tret_OptAlign',
        'altynbek07\emtypograph\EMT_Tret_Etc',
        'altynbek07\emtypograph\EMT_Tret_Text'
    );
